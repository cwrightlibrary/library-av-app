...
class PreviewCSV(customtkinter.CTkToplevel):
    def __init__(self, master, parent):
        ...
        self.av_issues_segmented_button.grid(row=0, column=0, padx=10, pady=10, sticky='new')
...
class OpenShowNewCSVFrame(customtkinter.CTkFrame):
    def __init__(self, master, parent):
        ...
        # New CSV button
        self.button_new_csv = customtkinter.CTkButton(self, text='New CSV', command=self.new_csv)
